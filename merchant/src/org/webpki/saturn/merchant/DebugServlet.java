    ...
    DebugPrintout(DebugData debugData, boolean clean) throws Exception {
        ...
        description(point +
         ...
         description(point +
            ...
            "list of accepted payment methods and associated  " +
        ...
        descriptionStdMargin("Explanations:<p>" +
            ...
            keyWord(CREDENTIAL_ID_JSON) + " holds a serial number or similar unique identifier associated with the virtual card.</p><p>" +
            ...
            keyWord(AUTHORIZATION_SIGNATURE_JSON) + " holds the user's authorization signature.</p>");
